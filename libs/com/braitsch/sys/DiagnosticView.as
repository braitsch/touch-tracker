package com.braitsch.sys {
	...
	public class DiagnosticView extends Sprite {
		...
		private function addEventListeners():void
		{
			...
			addEventListener(TouchEvent.TOUCH_OUT, onTouchEvent);
			addEventListener(TouchEvent.TOUCH_OVER, onTouchEvent);
			addEventListener(TouchEvent.TOUCH_ROLL_OUT, onTouchEvent);
			addEventListener(TouchEvent.TOUCH_ROLL_OVER, onTouchEvent);
